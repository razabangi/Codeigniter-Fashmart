...
<div class="container">
  <div class="row login-container animated fadeInUp">  
    ...
    <?php 
      $attributes = [ 'name' => 'formUpdatePassword', 'id' => 'formUpdatePassword', 'class' => 'animated fadeIn'];
    ...
    ?>
      <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
        ...
        <div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
          ...
          <button type="submit" class="btn btn-primary btn-cons" id="login_toggle">Reset Password</button>
          </div>
          </div>
        <?php echo form_close(); ?>
    </div>   
